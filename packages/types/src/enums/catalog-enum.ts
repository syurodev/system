...
/**
 * Content types for polymorphic relationships
 */
 ...
 */
export const getEnumKeys = <T extends Record<string, string | number>>(enumObject: T): Array<keyof T> => {
...
export const isContentStatus = (value: unknown): value is ContentStatus => {
  return typeof value === 'number' && Object.values(ContentStatus).includes(value);
};
...
export const isPricingType = (value: unknown): value is PricingType => {
  return typeof value === 'string' && Object.values(PricingType).includes(value as PricingType);
};
...
export const isMangaPublicationType = (value: unknown): value is MangaPublicationType => {
  return typeof value === 'number' && Object.values(MangaPublicationType).includes(value);
};

export const isReadingDirection = (value: unknown): value is ReadingDirection => {
  return typeof value === 'number' && Object.values(ReadingDirection).includes(value);
};
